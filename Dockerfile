...
############################################################################################################
FROM golang:1.24-alpine AS builder-casaos-gateway
...
############################################################################################################
FROM golang:1.24-alpine AS builder-casaos-user-service
...
############################################################################################################
FROM golang:1.24-alpine AS builder-casaos-message-bus
...
############################################################################################################
FROM golang:1.24-alpine AS builder-casaos-app-management
...
############################################################################################################
FROM golang:1.24-alpine AS builder-casaos-local-storage
...
############################################################################################################
FROM golang:1.24-alpine AS builder-casaos-main
...
############################################################################################################
FROM golang:1.24-alpine AS builder-casaos-cli
